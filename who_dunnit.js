...
// The murderer is Miss Scarlet because murderer had already been declared within the block (block scope)
...
// Constant variable cannot be reassigned use let variable instead
...
// Murderer in first verdict was declared within the block and only exists there. Pulled out as function was called. Global variable is Professor plum (second verdict)
...
// Scenario is constant but weapon is not so this is why it could be reassigned. Was called outside the block which makes it a global variable as it was used without declaring.
